...
DATABASES = {
    'default': {
        ...
        'NAME': config('PG_NAME', default='default'),
        'USER': config('PG_USER', default='default'),
        'PASSWORD': config('PG_PASSWORD', default='default'),
        'HOST': config('PG_HOST', default='default'),
        'PORT': config('PG_PORT', default='default'),
    }
}
